import shlex
file = open('redroute2.gpx')

# for file 1 start
# lat_lon_list = [{'name': 'Stop1: WP01-A', 'lat': '33.769921', 'lon': '-84.391754'}]
...
for line in file:
    ...
    if '<rtept' in line_list:
        ...
        # stops for red file 1
        if name == 'WP78':
            lat_lon_list.append({'name': 'Stop2: WP02-B', 'lat': '33.77228', 'lon': '-84.39548'})
        elif name == 'WP96':
            lat_lon_list.append({'name': 'Stop3: WP03-C', 'lat': '33.77274', 'lon': '-84.39706'})
        elif name == 'WP120':
            lat_lon_list.append({'name': 'Stop4: WP04-D', 'lat': '33.77346', 'lon': '-84.39916'})
        elif name == 'WP160':
            lat_lon_list.append({'name': 'Stop5: WP05-E', 'lat': '33.7751', 'lon': '-84.40239'})
        elif name == 'WP196':
            lat_lon_list.append({'name': 'Stop6: WP06-F', 'lat': '33.77827', 'lon': '-84.40419'})
        elif name == 'WP235':
            lat_lon_list.append({'name': 'Stop7: WP07-G', 'lat': '33.77962', 'lon': '-84.40471'})
        elif name == 'WP252':
            lat_lon_list.append({'name': 'Stop8: WP08-H', 'lat': '33.77963', 'lon': '-84.40274'})
        elif name == 'WP280':
            lat_lon_list.append({'name': 'Stop9: WP09-I', 'lat': '33.77845', 'lon': '-84.40082'})
        elif name == 'WP309':
            lat_lon_list.append({'name': 'Stop10: WP10-J', 'lat': '33.77818', 'lon': '-84.39733'})
        elif name == 'WP332':
            lat_lon_list.append({'name': 'Stop11: WP11-K', 'lat': '33.7771', 'lon': '-84.39548'})
        elif name == 'WP345':
            lat_lon_list.append({'name': 'Stop12: WP12-L', 'lat': '33.77689', 'lon': '-84.39378'})
        elif name == 'WP356':
            lat_lon_list.append({'name': 'Stop13: WP13-M', 'lat': '33.77669', 'lon': '-84.39212'})
        elif name == 'WP376':
            lat_lon_list.append({'name': 'Stop14: WP14-N', 'lat': '33.77495', 'lon': '-84.39205'})
        elif name == 'WP389':
            lat_lon_list.append({'name': 'Stop15: WP15-O', 'lat': '33.77398', 'lon': '-84.39204'})
        elif name == 'WP419':
            lat_lon_list.append({'name': 'Stop16: WP16-P', 'lat': '33.77145', 'lon': '-84.3921'})
        
        # stops for red file 2
        # if name == 'WP24-'
